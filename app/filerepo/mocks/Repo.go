...
import (
	...
	filerepo "github.com/Syncano/codebox/app/filerepo"
...
// PermStore provides a mock function with given fields: key, src, filename, mode
func (_m *Repo) PermStore(key string, src io.Reader, filename string, mode os.FileMode) (string, error) {
	ret := _m.Called(key, src, filename, mode)

	var r0 string
	if rf, ok := ret.Get(0).(func(string, io.Reader, string, os.FileMode) string); ok {
		r0 = rf(key, src, filename, mode)
	} else {
		r0 = ret.Get(0).(string)
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(string, io.Reader, string, os.FileMode) error); ok {
		r1 = rf(key, src, filename, mode)
	} else {
		r1 = ret.Error(1)
	}
...
// Store provides a mock function with given fields: key, storeKey, src, filename, mode
func (_m *Repo) Store(key string, storeKey string, src io.Reader, filename string, mode os.FileMode) (string, error) {
	ret := _m.Called(key, storeKey, src, filename, mode)

	var r0 string
	if rf, ok := ret.Get(0).(func(string, string, io.Reader, string, os.FileMode) string); ok {
		r0 = rf(key, storeKey, src, filename, mode)
	} else {
		r0 = ret.Get(0).(string)
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(string, string, io.Reader, string, os.FileMode) error); ok {
		r1 = rf(key, storeKey, src, filename, mode)
	} else {
		r1 = ret.Error(1)
	}
