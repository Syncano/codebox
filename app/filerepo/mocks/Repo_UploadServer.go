...
func (_m *Repo_UploadServer) Recv() (*v1.UploadRequest, error) {
	ret := _m.Called()
...
func (_m *Repo_UploadServer) Send(_a0 *v1.UploadResponse) error {
	ret := _m.Called(_a0)

	var r0 error
	if rf, ok := ret.Get(0).(func(*v1.UploadResponse) error); ok {
		r0 = rf(_a0)
	} else {
		r0 = ret.Error(0)
	}
