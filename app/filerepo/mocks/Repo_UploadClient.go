...
import (
	...
	v1 "github.com/Syncano/syncanoapis/gen/go/syncano/codebox/filerepo/v1"
)
...
func (_m *Repo_UploadClient) Recv() (*v1.UploadResponse, error) {
	ret := _m.Called()

	var r0 *v1.UploadResponse
	if rf, ok := ret.Get(0).(func() *v1.UploadResponse); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*v1.UploadResponse)
		}
	}
...
func (_m *Repo_UploadClient) Send(_a0 *v1.UploadRequest) error {
	ret := _m.Called(_a0)

	var r0 error
	if rf, ok := ret.Get(0).(func(*v1.UploadRequest) error); ok {
		r0 = rf(_a0)
	} else {
		r0 = ret.Error(0)
	}
