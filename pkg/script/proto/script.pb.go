...
func (*RunRequest) XXX_OneofFuncs() (func(msg proto1.Message, b *proto1.Buffer) error, func(msg proto1.Message, tag, wire int, b *proto1.Buffer) (bool, error), func(msg proto1.Message) (n int), []interface{}) {
...
func _RunRequest_OneofMarshaler(msg proto1.Message, b *proto1.Buffer) error {
	m := msg.(*RunRequest)
	// value
...
func _RunRequest_OneofUnmarshaler(msg proto1.Message, tag, wire int, b *proto1.Buffer) (bool, error) {
	m := msg.(*RunRequest)
	switch tag {
	case 1: // value.meta
...
func _RunRequest_OneofSizer(msg proto1.Message) (n int) {
	m := msg.(*RunRequest)
	// value
	switch x := m.Value.(type) {
	case *RunRequest_Meta:
...
func (m *RunRequest_MetaMessage_OptionsMessage) String() string { return proto1.CompactTextString(m) }
...
func (m *RunRequest_ChunkMessage) String() string            { return proto1.CompactTextString(m) }
...
func (m *HTTPResponseMessage) String() string            { return proto1.CompactTextString(m) }
...
func init() {
	proto1.RegisterType((*RunRequest)(nil), "script.RunRequest")
	proto1.RegisterType((*RunRequest_MetaMessage)(nil), "script.RunRequest.MetaMessage")
	proto1.RegisterType((*RunRequest_MetaMessage_OptionsMessage)(nil), "script.RunRequest.MetaMessage.OptionsMessage")
	proto1.RegisterType((*RunRequest_ChunkMessage)(nil), "script.RunRequest.ChunkMessage")
	proto1.RegisterType((*HTTPResponseMessage)(nil), "script.HTTPResponseMessage")
	proto1.RegisterType((*RunResponse)(nil), "script.RunResponse")
}
...
func (m *RunRequest_MetaMessage_OptionsMessage) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Async != 0 {
		dAtA[i] = 0x40
		i++
		i = encodeVarintScript(dAtA, i, uint64(m.Async))
	}
	return i, nil
}
...
func (m *RunResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.ContainerID) > 0 {
		dAtA[i] = 0x4a
		i++
		i = encodeVarintScript(dAtA, i, uint64(len(m.ContainerID)))
...
func init() { proto1.RegisterFile("pkg/script/proto/script.proto", fileDescriptorScript) }

var fileDescriptorScript = []byte{
	// 672 bytes of a gzipped FileDescriptorProto
	,
}
